...
use IrcScheduledRoom\Models\TipoEvento;

use Validator;

class TiposEventoController extends CrudController {

    protected $model = '\IrcScheduledRoom\Models\TipoEvento';
    protected $path = 'tiposEvento';
    ...
    public function store(Request $request)
    {
        ...
        $messages = [
            ...
            'descricao.required' => 'O campo RAZÃO SOCIAL é obrigatório.'
        ];
