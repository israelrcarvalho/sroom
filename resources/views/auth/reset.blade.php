...
<html lang="en">
    ...
    <head>
        ...
        <title>Resetar senha | SheduledRoom</title>
...
{{--                    <h3 class="img-responsive"><a href="{{ URL::to('auth/login') }}"><img src="../images/logo.png" style="width:100%"  alt="Logotipo"/></a></h3>--}}
                    @if (session('status'))
                    ...
                    @endif
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                {!! Form::password('password', ['class'=> 'form-control','autofocus','placeholder'=> 'Senha']) !!}
                            </div>

                            <div class="form-group">
                                {!! Form::password('password_confirmation', ['class'=> 'form-control','autofocus','placeholder'=> 'Confirmar Senha']) !!}
                            </div>

                            {!! Form::submit('Redefinir Senha',['class' => 'btn btn-lg btn-success btn-block']) !!}
                        </fieldset>
                        {!! Form::close() !!}
                    </div>
                </div>
