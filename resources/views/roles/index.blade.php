...
<div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb page-header">
                <li><a href="{{ route('permission.index') }}">Papeis</a></li>
                <li>Lista</li>
            </ol>
        </div>
    </div>
                ...
                @include('recursos.partials.success')
                    ...
                    @foreach($objModel as $p)
                      ...
                      <span class="glyphicon glyphicon-edit" style="cursor:pointer;"
                            data-toggle="modal"
                            data-target="#modal-edit-role-{{$p->id}}"/>
                            ...
                            <td align="center">
                                ...
                                <span style="cursor:pointer;"
                                      ...
                                      data-toggle="modal"
                                      data-target="#modal-delete-role-{{$p->id}}"></span>

                            </td>
                        </tr>

                        {{-- Confirm Delete --}}
                        <div class="modal fade" id="modal-delete-role-{{$p->id}}" tabIndex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form method="GET" action="{{ route('role.destroy',['id'=>$p->id]) }}">
                        ...
                        @include('roles.partials.modal-edit-role')
...
@include('roles.partials.modal-create-role')
@endsection